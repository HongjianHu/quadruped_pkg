...
#include <quadruped_controller_msgs/msg/inputs.h>
...
// ---- 控制器主类 ----
class QuadrupedController final
...
protected:
  ...
  // FR FL RR RL
  std::vector<double> stand_pos_ = {0.0, 0.67, -1.3, 0.0, 0.67, -1.3,
                                    0.0, 0.67, -1.3, 0.0, 0.67, -1.3};

  std::vector<double> down_pos_ = {0.0, 1.3, -2.4, 0.0, 1.3, -2.4,
                                   0.0, 1.3, -2.4, 0.0, 1.3, -2.4};
