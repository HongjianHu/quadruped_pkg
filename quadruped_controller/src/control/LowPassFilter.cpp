...
LowPassFilter::LowPassFilter(const double samplePeriod,
                             const double cutFrequency) {
...
double LowPassFilter::getValue() const { return pass_value_; }

void LowPassFilter::clear() { start_ = false; }
