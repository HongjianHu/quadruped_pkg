...
StateFixedDown::StateFixedDown(CtrlInterfaces &ctrl_interfaces, const std::vector<double> &down_pos, double kp,
                               double kd)
    : FSMState(FSMStateName::FIXEDDOWN, "FIXEDDOWN", ctrl_interfaces), target_pos_(down_pos), kp_(kp), kd_(kd),
      loop_count_(0)
{
}
